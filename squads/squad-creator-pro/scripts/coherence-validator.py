...
Purpose: Validate systemic coherence across squad-creator-pro configs
...
Agents covered:
- @pedro-valerio-pro: SC_HE_*, SC_VC_* (build/process)
- @oalanicolas-pro: AN_HE_*, AN_VC_* (extraction/research)
...
def validate_heuristic_veto_coverage(
    ...
    Agents:
    - @pedro-valerio-pro: SC_HE_* → SC_VC_*
    - @oalanicolas-pro: AN_HE_* → AN_VC_*
    """
    result = {
        "rule": "heuristic_veto_coverage",
        "passed": True,
...
def main():
    parser = argparse.ArgumentParser(
        description="Validate coherence across squad-creator-pro configs"
    )
