...
template:
  ...
  specialists:
    mind_cloning: "@oalanicolas-pro"
    process_validation: "@pedro-valerio-pro"
    notes: |
      For mind-based agents (cloned from real experts):
      - Invoke @oalanicolas-pro for DNA extraction: *extract-dna, *assess-sources
      - Use DNA Mental™ 8-Layer Architecture for complete clone
      For process/workflow validation:
      - Invoke @pedro-valerio-pro for: *audit, *design-heuristic, *veto-check
