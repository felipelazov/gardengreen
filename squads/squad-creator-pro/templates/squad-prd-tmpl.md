...
|------|---------|-------------|--------|
| {{DATE}} | 1.0.0 | Initial PRD | @squad-chief-pro |
...
2. **Invoke:** `@squad-chief-pro *create-squad {{PACK_NAME}} --epic=1`
3. **Validate:** After each epic, run `*validate-squad {{PACK_NAME}}`
4. **Iterate:** Proceed to next epic after validation passes

### Handoff

- **To @squad-chief-pro:** Implement Epic 1
- **To @oalanicolas-pro:** Clone minds for Tier 0 agents
- **To @pedro-valerio-pro:** Validate workflow quality gates
