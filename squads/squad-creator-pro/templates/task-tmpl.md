template:
  ...
  version: 2.1
  specialists:
    process_design: "@pedro-valerio-pro"
    mind_extraction: "@oalanicolas-pro"
    notes: |
      For tasks involving mind cloning or DNA extraction:
      - Add `specialist: "@oalanicolas-pro"` to frontmatter
      - Add `specialist_guidance:` with relevant instructions
      For tasks involving workflows, validation, or checklists:
      - Add `specialist: "@pedro-valerio-pro"` to frontmatter
