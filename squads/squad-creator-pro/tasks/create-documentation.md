...
rationale: |
  ...
  "Se não está documentado, não existe." — @pedro-valerio-pro
---
...
Criar documentação completa e padronizada para cada artefato do squad-creator-pro.
...
|------|-------------|------|------|
| 1 | @oalanicolas-pro | Extrai conhecimento | `extract-*.md` |
| 2 | @pedro-valerio-pro | Operacionaliza (SOPs, checklists) | `extract-sop.md`, etc |
| **3** | **@pedro-valerio-pro** | **Documenta** | **`create-documentation.md`** |
| 4 | @squad-chief-pro | Monta squad final | `create-squad.md` |
...
*Task criada por @pedro-valerio-pro — "Se não está documentado, não existe"*
