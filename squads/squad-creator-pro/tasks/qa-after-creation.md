...
**Process Specialist:** @pedro-valerio-pro
**Specialist Guidance:**
- Use Process Absolutism principles for validation
- Define VETO conditions that BLOCK, not just warn
- For workflow/process validation, invoke: `@pedro-valerio-pro *audit`
- For designing quality gates, invoke: `@pedro-valerio-pro *design-heuristic`
