...
1. Saber ativar: `@squad-creator-pro`
...
Se você tem o Squad Creator na pasta `squads/squad-creator-pro`, já está instalado. Basta ativar:
```
@squad-creator-pro
```
...
```
         ┌─────────────────┐
         │  @squad-chief-pro   │ ← Ponto de entrada
         │  (Orchestrator) │
         └────────┬────────┘
                  │
       ┌──────────┴──────────┐
...
|--------|-------|----------|
| `@squad-chief-pro` | Orquestração, triagem, criação, SOPs | `@squad-creator-pro` |
| `@oalanicolas-pro` | Mind cloning, DNA extraction | `@squad-creator-pro:oalanicolas` |
| `@pedro-valerio-pro` | Process design, veto conditions | `@squad-creator-pro:pedro-valerio` |

### Quando usar @squad-chief-pro?
...
Ele roteia automaticamente: se precisa DNA → @oalanicolas-pro, se precisa artefatos → @pedro-valerio-pro.

### Quando usar @oalanicolas-pro?
...
```
1. USER → @squad-chief-pro: "Quero squad de copywriting"
2. @squad-chief-pro pesquisa elite minds
3. @squad-chief-pro → @oalanicolas-pro: "Clone Gary Halbert"
4. @oalanicolas-pro extrai DNA e devolve
5. @oalanicolas-pro → @pedro-valerio-pro: "Crie agent com este DNA"
6. @pedro-valerio-pro cria artefatos e devolve
7. @squad-chief-pro integra tudo
8. SQUAD READY
```

### E se não souber qual usar?

**Sempre comece com `@squad-creator-pro` (squad-chief).** Ele faz a triagem e delega automaticamente.
...
| Comando | O que faz |
|---------|-----------|
| `@squad-creator-pro` | Ativa o Squad Creator |
