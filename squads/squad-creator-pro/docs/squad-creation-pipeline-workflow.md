...
**Autores:** @oalanicolas-pro (Knowledge Architect) + @pedro-valerio-pro (Process Architect)
...
@oalanicolas-pro (Knowledge Architect) extrai "O QUE o expert sabe/pensa"
@pedro-valerio-pro (Process Architect) transforma em "COMO fazer sem errar"
```
...
```
┌────────────┐     ┌───────────────────────┐     ┌────────────────┐     ┌────────────┐
│   CHIEF    │ ──► │    @oalanicolas-pro       │ ──► │ @pedro-valerio-pro │ ──► │   CHIEF    │
...
|---------------------------|-------|
| "O que ele pensa?" | @oalanicolas-pro |
| "Como ele decide?" | @oalanicolas-pro |
| "Qual o modelo mental?" | @oalanicolas-pro |
| "Quais as heurísticas?" | @oalanicolas-pro |
| "Como fazer sem errar?" | @pedro-valerio-pro |
| "Qual a sequência?" | @pedro-valerio-pro |
| "Como validar?" | @pedro-valerio-pro |

### Mapeamento de Artefatos

| Artefato | Tipo | Owner |
|----------|------|-------|
| `*-framework.md` | Knowledge | @oalanicolas-pro |
| `*_dna.yaml` | Knowledge | @oalanicolas-pro |
| `core_principles.yaml` | Knowledge | @oalanicolas-pro |
| `mental_models.yaml` | Knowledge | @oalanicolas-pro |
| `heuristics.yaml` | Knowledge | @oalanicolas-pro |
| `signature_phrases.yaml` | Knowledge | @oalanicolas-pro |
| `source-index.yaml` | Knowledge | @oalanicolas-pro |
| `*-sop.md` | Operationalization | @pedro-valerio-pro |
| `*-checklist.md` | Operationalization | @pedro-valerio-pro |
| `*-workflow.yaml` | Operationalization | @pedro-valerio-pro |
| `*-blueprint.yaml` | Operationalization | @pedro-valerio-pro |
...
flowchart TB
    subgraph PHASE_0["Fase 0: INTAKE"]
        START([User Request]) --> CHIEF["@squad-chief-pro<br/>Triagem"]
    ...
    subgraph PHASE_1["Fase 1: KNOWLEDGE (Research + Extraction)"]
        USER_APPROVAL -->|Sim| AN["@oalanicolas-pro<br/>Knowledge Architect"]
    ...
    subgraph PHASE_2["Fase 2: OPERATIONALIZATION"]
        PV["@pedro-valerio-pro<br/>Process Architect"]
    ...
    subgraph PHASE_3["Fase 3: ASSEMBLY"]
        ASSEMBLY["@squad-chief-pro<br/>ASSEMBLY"]
...
stateDiagram-v2
    ...
    note right of Knowledge : @oalanicolas-pro
    note right of Operationalization : @pedro-valerio-pro
    note right of Assembly : @squad-chief-pro
```
...
sequenceDiagram
    ...
    participant SC as @squad-chief-pro
    participant AN as @oalanicolas-pro
    participant PV as @pedro-valerio-pro
...
|---------|------|---------|
| Framework sem citações de fonte | REJECT | @oalanicolas-pro |
| DNA sem signature phrases reais | REJECT | @oalanicolas-pro |
| Heurísticas sem contexto de aplicação | REJECT | @oalanicolas-pro |
| Conceito inventado detectado | REJECT | @oalanicolas-pro |
...
|-------|-------|
| **ID** | `handoff_pv_chief` |
| **De** | @pedro-valerio-pro |
| **Para** | @squad-chief-pro |
...
| Trigger | Ação | Destino |
|---------|------|---------|
| SOP não referencia framework | REJECT | @pedro-valerio-pro (inventou) |
| Falta conhecimento para SOP | REJECT | @oalanicolas-pro (extração incompleta) |
...
### @oalanicolas-pro - Knowledge Architect
...
### @pedro-valerio-pro - Process Architect
...
1. **squad-creator-pro config** em `squads/squad-creator-pro/config.yaml`
...
| `WebFetch` | Coleta de conteúdo | @oalanicolas-pro |
| `Grep/Glob` | Análise de patterns | @oalanicolas-pro |
...
*Documentação criada por @oalanicolas-pro (Knowledge Architect) + @pedro-valerio-pro (Process Architect)*

*"Curadoria > Volume" — @oalanicolas-pro*
*"A melhor coisa é impossibilitar caminhos" — @pedro-valerio-pro*
