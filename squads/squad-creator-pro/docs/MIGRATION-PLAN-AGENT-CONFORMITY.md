...
Este documento é um plano para **padronizar 3 arquivos de agent** do squad-creator-pro. Agents são arquivos `.md` que definem a personalidade, comandos e comportamento de um assistente de IA especializado.
...
_Plano criado por @pedro-valerio-pro | 2026-02-10_
