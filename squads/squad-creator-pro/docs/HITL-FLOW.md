...
|------------|-------------------|--------|
| PRE-FLIGHT | @squad-chief-pro | Triagem e seleção de modo |
| VALIDATE_MINDS | @squad-chief-pro | Apresentar elite minds |
| MATERIALS | @squad-chief-pro | Coletar materiais |
| VOICE_DNA | @oalanicolas-pro | Validar DNA de voz extraído |
| THINKING_DNA | @oalanicolas-pro | Validar DNA de pensamento |
| AGENTS | @pedro-valerio-pro | Validar agents criados |
| FINAL | @squad-chief-pro | Apresentar squad completo |
