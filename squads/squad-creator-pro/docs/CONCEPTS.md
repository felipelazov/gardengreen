...
│                ▼                             ▼                  │
│     ┌─────────────────┐           ┌─────────────────┐          │
│     │  @oalanicolas-pro   │  HANDOFF  │ @pedro-valerio-pro  │          │
│     │   (Tier 1)      │◄─────────►│   (Tier 1)      │          │
│     │                 │           │                 │          │
...
**Delega para:** @oalanicolas-pro (DNA), @pedro-valerio-pro (artefatos)

### @oalanicolas-pro (Tier 1 - Mind Cloning)
...
### @pedro-valerio-pro (Tier 1 - Process Design)
...
```
USER → @squad-chief-pro (triage)
              │
              ├── Precisa DNA? → @oalanicolas-pro
              │                        │
              │                        ▼
              │                 INSUMOS_READY
              │                        │
              └── Precisa artefatos? ──┼──→ @pedro-valerio-pro
                                       │            │
                                       │            ▼
                                       │     ARTIFACTS_READY
                                       │            │
...
|----------|--------------|
| Extrair DNA de expert | `@oalanicolas-pro` |
| Avaliar fontes | `@oalanicolas-pro` |
| Clone não soa autêntico | `@oalanicolas-pro` |
| Criar workflow | `@pedro-valerio-pro` |
| Definir veto conditions | `@pedro-valerio-pro` |
| Auditar processo | `@pedro-valerio-pro` |
