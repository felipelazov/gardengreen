...
| 2 | Structure | Transcript | Steps, roles, tools | @squad-chief-pro |
| 3 | Task Anatomy | Steps | 8-field tasks | @squad-chief-pro |
| 4 | Cognitive | Steps | Executor types | @squad-chief-pro |
| 5 | Decision Rules | Transcript | IF/THEN rules | @squad-chief-pro |
| 6 | Automation | Steps | PV_PM_001 decisions | @squad-chief-pro |
| 7 | Quality | Process | META-AXIOMAS score | @squad-chief-pro |
| 8 | Blueprint | All above | Squad YAML | @squad-chief-pro |
| 9 | Gaps | All above | Gap report | @squad-chief-pro |
| 10 | Assembly | All above | SOP document | @squad-chief-pro |
| 11 | Validation | SOP | APPROVE/REVIEW/REJECT | Human + SC-CK-001 |
| 12 | Handoff | Approved SOP | Working squad | @squad-chief-pro |
...
| Agent Definition | `agents/squad-chief-pro.md` | @squad-chief-pro persona (includes SOP extraction) |
