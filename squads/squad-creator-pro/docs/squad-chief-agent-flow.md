# Sistema do Agente @squad-chief-pro

> **Versão:** 3.0.0
> **Criado:** 2026-02-10
> **Atualizado:** 2026-02-11
> **Owner:** @squad-chief-pro (Squad Architect)
...
O agente **@squad-chief-pro (Squad Architect)** é o **Master Orchestrator** do squad-creator-pro. Este agente atua como **Orchestrator Tier 0** que coordena criação de squads, roteamento para especialistas, e garantia de qualidade.

### Quando Usar

**USE @squad-chief-pro para:**
...
**NÃO USE @squad-chief-pro para:**
- Extração de Voice/Thinking DNA detalhada → use @oalanicolas-pro
- Validação de workflows/processos → use @pedro-valerio-pro
- Deconstructing frameworks específicos → use @oalanicolas-pro
...
### Arquivos Core de Tasks do @squad-chief-pro
...
### Arquivos de Mind Cloning (Delegados para @oalanicolas-pro)
...
### Arquivos de Process Validation (Delegados para @pedro-valerio-pro)
...
| `.claude/commands/squad-creator-pro/agents/squad-chief.md` | Comando Claude Code para ativar |
...
### Flowchart: Sistema Completo do @squad-chief-pro

```mermaid
flowchart TB
    subgraph ACTIVATION["ATIVAÇÃO DO AGENTE"]
        A["@squad-chief-pro"] --> B["Carrega Persona"]
    ...
    subgraph ROUTING["SPECIALIST ROUTING"]
        ...
        K -->|"Mind Cloning"| L["@oalanicolas-pro"]
        K -->|"Process Design"| M["@pedro-valerio-pro"]
...
### Diagrama de Estados do @squad-chief-pro
...
flowchart TB
    subgraph SQUAD_CREATOR["SQUAD-CREATOR ECOSYSTEM"]
        CHIEF["@squad-chief-pro<br/>(Orchestrator)"]
    end

    subgraph SPECIALISTS["TIER 1 SPECIALISTS"]
        AN["@oalanicolas-pro<br/>(Mind Cloner)"]
        PV["@pedro-valerio-pro<br/>(Process Absolutist)"]
        TF["@oalanicolas-pro<br/>(Deconstructor)"]
    end

    subgraph EXTERNAL["EXTERNAL AGENTS"]
        QA["@qa-architect<br/>(Deep Validation)"]
        DEV["@dev<br/>(Implementation)"]
        DESIGN["@ux-design-expert<br/>(UI/UX)"]
    end
...
|----|------|---------|------|
| User | @squad-chief-pro | "create squad for {domain}" | Initiate research loop |
| @squad-chief-pro | @oalanicolas-pro | "clone mind {name}" | Extract Voice + Thinking DNA |
| @oalanicolas-pro | @squad-chief-pro | DNA complete | Continue agent creation |
| @squad-chief-pro | @pedro-valerio-pro | "validate workflow" | Audit for veto conditions |
| @pedro-valerio-pro | @squad-chief-pro | Audit report | Apply fixes or approve |
| @squad-chief-pro | @oalanicolas-pro | "deconstruct {system}" | Extract frameworks |
| @oalanicolas-pro | @squad-chief-pro | Frameworks extracted | Use in agent creation |
...
| Deconstruction, framework extraction | "deconstruct", "extract framework" | @oalanicolas-pro |
...
| UI/UX design needed | "design UI", "interface" | @ux-design-expert |
...
O @squad-chief-pro deve **HALT** e perguntar ao usuário quando:
...
**NÃO USE @squad-chief-pro para:**
- Extração detalhada de Voice/Thinking DNA → @oalanicolas-pro
- Validação de processos/workflows → @pedro-valerio-pro
- Deconstructing frameworks específicos → @oalanicolas-pro
- Implementação de código → @dev
- Design de UI/UX → @ux-design-expert

### Ciclo de Execução Recomendado

1. **Ative o agente** com `@squad-chief-pro` ou `/squad-creator-pro:agents:squad-chief`
...
```
Erro: Handoff para @oalanicolas-pro falhou - context insufficient
```
...
| **Agent Collaboration** | `squads/squad-creator-pro/docs/AGENT-COLLABORATION.md` |
...
| **Agentes Core** | 3 (@squad-chief-pro, @oalanicolas-pro, @pedro-valerio-pro) |
...
|------|-------|-----------|
| 2026-02-10 | @pedro-valerio-pro | Documento inicial criado aplicando agent-flow-doc-tmpl.md |
