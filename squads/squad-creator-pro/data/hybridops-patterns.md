...
**NOTA:** Os arquivos são COPIADOS uma vez. Atualizações futuras devem ser feitas no squad-creator-pro diretamente.
...
- Criar questões validação específicas para squad-creator-pro
...
- Validar que agent do squad-creator-pro segue suas próprias axiomas
...
| 3 | `responsible_executor` | string | role or @agent reference | "@squad-creator-pro:analyzer" |
...
task_definition:
  ...
  status: "pending"
  responsible_executor: "@squad-creator-pro:analyzer"
...
phase: 3
scope: "All agents generated by squad-creator-pro"
...
example:
  agent: "@squad-creator-pro:analyzer"
...
axioma_assessment:
  ...
  assessor: "@squad-creator-pro:qa-architect"
...
- task_id: IMP-006
  ...
  pattern: HO-EP-003
  assigned_to:
    design: "@squad-creator-pro:architect"  # AI designs automation logic
...
- task_id: COMP-W01
  ...
  worker_logic: |
    IF task_type = 'agent' AND created_by = '@squad-creator-pro'
...
agents:
  - name: "@squad-creator-pro:analyzer"
...
Para implementar todos os patterns no squad-creator-pro, criar:
...
Se insumos incompletos, Pedro Valério **devolve** para @oalanicolas-pro:
...
veto_handoff:
  ...
  action: "DEVOLVER para @oalanicolas-pro com lista específica"
```
...
- **5 Mind Artifacts** COPIADOS para dentro do squad-creator-pro (self-contained)
- **Integração com workflow** squad-chief → oalanicolas → pedro-valerio
- **Zero referências externas** - squad é 100% portável

Todos estão **prontos para adaptação** ao squad-creator-pro com minimal customization. Recomendo iniciar pela **Fase 0 (Agent Update)** antes dos patterns.
